...
- Soporte TI: validación rápida de disponibilidad de endpoints críticos.
- Operaciones/NOC: comprobaciones recurrentes y comparación de cambios de estado.
- Post-deploy: verificación de exposición de puertos esperados.
- Inventario técnico: descubrimiento inicial y salida JSON para trazabilidad.
- Hardening interno: detección de servicios sensibles expuestos.

## Alcance y Limitaciones

- Orientado a IPv4.
- Escaneo TCP tipo connect; no realiza fingerprinting avanzado.
- No sustituye herramientas de pentesting avanzadas.
- Recomendado para redes internas y entornos con autorización explícita.

## Roadmap Sugerido

- Exportación a archivo (`--output-file`).
- Resolución DNS inversa por host.
- Modo con rangos de puertos (`--port-range`).
- Thread pool dedicado y métricas de rendimiento por etapa.
- Tests unitarios para parsing, normalización y formateo.

## Competencias Técnicas Demostradas

Este proyecto demuestra competencias en:

- Diseño modular de software en C++.
- Programación de red en entorno Windows (WinSock, ICMP/IP Helper).
- Concurrencia y orquestación de cargas.
- Modelado de datos técnicos para observabilidad.
- Desarrollo de herramientas CLI con UX interactiva.
- Integración operativa mediante salida JSON.

---

Si quieres adaptar este scanner para un entorno concreto (NOC, SOC, MSP o laboratorio), puedes extender fácilmente el módulo `output` y la capa `core` sin romper contratos públicos.
